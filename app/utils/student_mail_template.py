...
<head>
    ...
    <title>PyCon Togo 2026 – Student Pass Confirmed</title>
    <!--[if mso]>
  <noscript>
    <xml>
            ...
            <tr>
                <td>
                    <div class="email-container">
                        ...
                        <!-- ===== HEADER IMAGE ===== -->
                        <!-- Remplace le src ci-dessous par le lien ImageKit de ton image d'en-tête PyCon Togo 2026 -->
                        ...
                        <div class="body-content">
                            <h1 class="title">Your PyCon Togo 2026 Student Pass<br>is Confirmed</h1>
                            <p class="greeting">Hello {{firstName}},</p>
                            <p class="pass-confirmed">
                                Your <span class="highlight">STUDENT PASS</span> has been successfully issued.
                            </p>
                        </div>
                        <div style="padding: 0 36px 0 36px;">
                            <div class="ticket-card">
                                <div class="ticket-image-wrapper">
                                    <img src="{{TICKET_URL}}"
                                        alt=" PyCon Togo 2026 Student Pass – {{firstName}}" width="528" />
                                </div>
                                ...
                                <table class="ticket-details" role="presentation">
                                    <tr>
                                        ...
                                        <td class="detail-value student-pass">STUDENT PASS</td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="ticket-details" role="presentation">
                                    <tr>
                                        ...
                                        <td class="detail-value" style="font-size: 13px;">DAY 1 – DAY 2 (28–29 AUGUST
                                            2026)</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="section">
                            <p class="section-title">Student Pass Benefits:</p>
                            <ul>
                                <li>Access to all Day 1 &amp; Day 2 sessions</li>
                                <li>Student-focused workshops &amp; talks</li>
                                <li>Networking with developers and mentors</li>
                                <li>Meet and greet with industry professionals</li>
                        ...
                        <div class="section">
                            ...
                            <ul>
                                ...
                                <li>Please bring a valid student ID for verification or any other acceptable
                                    identification.</li>
...
def render_student_pass_email(first_name, full_name, ticket_id, ticket_url, qr_url):
