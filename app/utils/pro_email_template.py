...
<head>
    ...
    <title>PyCon Togo 2026 – Professional Pass Confirmed</title>
    <!--[if mso]>
  <noscript>
    <xml>
                ...
                <td>
                    <div class="email-container">
                        ...
                        <div class="body-content">
                            <h1 class="title">Your PyCon Togo 2026 Professional Pass<br>is Confirmed</h1>
                            <p class="greeting">Hello {{firstName}},</p>
                            <p class="pass-confirmed">
                                Your <span class="highlight">PROFESSIONAL PASS</span> has been successfully issued.
                            </p>
                        </div>
                        <div style="padding: 0 36px 0 36px;">
                            <div class="ticket-card">
                                <div class="ticket-image-wrapper">
                                    <img src="{{TICKET_URL}}" alt=" PyCon Togo 2026 Professional Pass – {{firstName}}"
                                        width="528" />
                                </div>
                                ...
                                <table class="ticket-details" role="presentation">
                                    <tr>
                                        ...
                                        <td class="detail-value pro-pass">PROFESSIONAL PASS</td>
                                    </tr>
                                    <tr>
                        ...
                        <!-- ===== PROFESSIONAL PASS BENEFITS ===== -->
                        <div class="section">
                            <p class="section-title">Professional Pass Benefits:</p>
                            <ul>
                                <li>Access to all Day 1 &amp; Day 2 sessions</li>
                                <li>Professional-focused workshops &amp; talks</li>
