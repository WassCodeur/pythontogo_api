...
<head>
    ...
    <title>PyCon Togo 2026 – Dinner Pass Confirmed</title>
    <!--[if mso]>
  <noscript>
    <xml>
                ...
                <td>
                    <div class="email-container">
                        ...
                        <div class="body-content">
                            <h1 class="title">Your PyCon Togo 2026 Dinner Pass<br>is Confirmed</h1>
                            <p class="greeting">Hello {{firstName}},</p>
                            <p class="pass-confirmed">
                                Your <span class="highlight">DINNER PASS</span> has been successfully issued.
                            </p>
                        </div>
                        <div style="padding: 0 36px 0 36px;">
                            <div class="ticket-card">
                                <div class="ticket-image-wrapper">
                                    <img src="{{TICKET_URL}}" alt=" PyCon Togo 2026 Dinner Pass – {{firstName}}"
                                        width="528" />
                                </div>
                                ...
                                <table class="ticket-details" role="presentation">
                                    <tr>
                                        ...
                                        <td class="detail-value premium-pass">DINNER PASS</td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="ticket-details" role="presentation">
                                    <tr>
                                        ...
                                        <td class="detail-value" style="font-size: 13px;">DINNER DAY3 (30 AUGUST
                                            2026)</td>
                                    </tr>
                                    <tr>
                        ...
                        <!-- ===== DINNER PASS BENEFITS ===== -->
                        <div class="section">
                            <p class="section-title">Dinner Pass Benefits:</p>
                            <ul>
...
def render_dinner_pass_email(first_name, full_name, ticket_id, ticket_url, qr_url):
